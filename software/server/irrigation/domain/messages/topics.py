# coding=utf-8
TOPIC_AREA_SENSORS_STATUS_CONTROLLER = "area/{area}/controller/{controller}/sensors/status"
TOPIC_AREA_SENSORS_STATUS_CONTROLLER_REGEXP = "area/([0-9]+)/controller/([0-9]+)/sensors/status"
...
TOPIC_AREA_ACTUATOR_RELAY_REGEXP = "area/([0-9]+)/actuator/off"
